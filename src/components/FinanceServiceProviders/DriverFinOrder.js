...
function ProductInformationUI( {dispatch, data, showModal, showEditModal,  changeObject, pagination, cascaderOptions,currentPage,currentCarType,currentProvince,currentCity ,cities,currentUserInfo} ) {
  ...
  function confirmFun(index) {
    ...
    dispatch({
      type: 'financeOrderInformation/handleOrderInformation',
      payload: {
        oprType: 'del', ...value,
      }
    })
  ...
  function handleTableChange(pagination) {
    ...
    dispatch({
      type: 'financeOrderInformation/fetch',
      payload:{
        current: current,
    ...
    dispatch({
      type: 'financeOrderInformation/updateCurrentPage',
      payload: {
  ...
  function edit(text, record, index) {
    ...
    dispatch({
      type: 'financeOrderInformation/handleTrafficEdit',
      payload: record
    })
  }
  ...
  function handleShowModal() {
    dispatch({
      type:'financeOrderInformation/triggerModal'
    })
  }
  ...
  function handleEditCancel() {
    dispatch({
      type:'financeOrderInformation/handleEditCancel'
    })
  }
  ...
  function onChange(value) {
    if(value != ''){
        dispatch({
          type: 'financeOrderInformation/updateCities',
          payload: {
            value : value
          } ,
        });
    ...
    dispatch({
      type: 'financeOrderInformation/updateCurrentProvince',
      payload: {
  ...
  function changeCarType(value){
    dispatch({
      type: 'financeOrderInformation/updateCurrentCarType',
      payload: {
  ...
  function changeCity(value){
    dispatch({
      type: 'financeOrderInformation/updateCurrentCity',
      payload: {
        currentCity:value
      } ,
    });
  ...
  function changeUserInfo(event){
    dispatch({
        type: 'financeOrderInformation/updateCurrentUserInfo',
        payload: {
