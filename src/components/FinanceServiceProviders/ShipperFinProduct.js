...
function ProductInformationUI( {dispatch, data, showModal, showEditModal,  changeObject, pagination, cascaderOptions,currentPage,currentCarType,currentProvince,currentCity ,currentUserInfo,cities} ) {
  ...
  function handleTableChange(pagination) {
    ...
    dispatch({
      type: 'shipperFinProductInformation/updateCurrentPage',
      payload: {
  ...
  function edit(text, record, index) {
    ...
    dispatch({
      type: 'shipperFinProductInformation/handleTrafficEdit',
      payload: record
    })
  }
  ...
  function handleShowModal() {
    dispatch({
      type:'shipperFinProductInformation/triggerModal'
    })
  }
  ...
  function handleEditCancel() {
    dispatch({
      type:'shipperFinProductInformation/handleEditCancel'
    })
  }
  ...
  function onChange(value) {
    if(value != ''){
        dispatch({
          type: 'shipperFinProductInformation/updateCities',
          payload: {
            value : value
          } ,
        });
    ...
    dispatch({
      type: 'shipperFinProductInformation/updateCurrentProvince',
      payload: {
  ...
  function changeCarType(value){
    dispatch({
      type: 'shipperFinProductInformation/updateCurrentCarType',
      payload: {
  ...
  function changeCity(value){
    dispatch({
      type: 'shipperFinProductInformation/updateCurrentCity',
      payload: {
        currentCity:value
      } ,
    });
  ...
  function changeUserInfo(event){
    dispatch({
        type: 'shipperFinProductInformation/updateCurrentUserInfo',
        payload: {
