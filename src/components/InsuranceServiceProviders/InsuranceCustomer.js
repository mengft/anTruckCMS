...
function InsuranceCustomerInformationUI( {dispatch, data, showModal, showEditModal,  changeObject, pagination,currentUserInfo} ) {
  ...
  function edit(text, record, index) {
    ...
    dispatch({
      type: 'insuranceCustomerInformation/handleEdit',
      payload: {
  ...
  function handleShowModal() {
    dispatch({
      type:'insuranceCustomerInformation/triggerModal'
    })
  }
  ...
  function handleEditCancel() {
    dispatch({
      type:'insuranceCustomerInformation/handleEditCancel'
    })
  }

  function changeUserInfo(event){
    dispatch({
        type: 'insuranceCustomerInformation/updateCurrentUserInfo',
        payload: {
...
export default InsuranceCustomerInformationUI;
