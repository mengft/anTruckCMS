...
function TrafficCustomerInformationUI( {dispatch, data, showModal, changeObject, pagination,currentUserInfo} ) {

  //确认编辑 按钮.
  function confirmFun(index) {
    const value = data[index];
    dispatch({
      type: 'trafficCustomerInformation/handleTrafficCustomerInformation',
      payload: {
        type: 'del', ...value,
      }
    })
  ...
  function handleTableChange(pagination) {
    dispatch({
      type: 'trafficCustomerInformation/fetch',
      payload:{
  ...
  function edit(text, record, index) {
    ...
    dispatch({
      type: 'trafficCustomerInformation/handleEdit',
      payload: {
  ...
  function handleShowModal() {
    dispatch({
      type:'trafficCustomerInformation/triggerModal'
    })
  }
  ...
  function handleEditCancel() {
    dispatch({
      type:'trafficCustomerInformation/handleEditCancel'
    })
  }

  function changeUserInfo(event){
    dispatch({
        type: 'trafficCustomerInformation/updateCurrentUserInfo',
        payload: {
...
export default TrafficCustomerInformationUI;
