import * as OrderInformationServices from '../../services/DriverFinOrder'
...
export default {
  namespace: 'financeOrderInformation',
  ...
  effects: {
    *fetch( { payload: { current,car_type,province_id,city_id,status,userInfo } }, {call, put}){
      const data = yield call(OrderInformationServices.fetchInformation, { current:current,car_type:car_type,province_id:province_id,city_id:city_id,status:status,userInfo:userInfo });
