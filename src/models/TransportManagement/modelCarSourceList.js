import * as CarSourceListServices from '../../services/CarSourceList'
import { PAGE_SIZE } from '../../constants'
import { routerRedux } from 'dva/router';
import { warning, success, error } from '../../utils/noticeTips'

export default {
  namespace: 'carSourceListState',
  ...
  effects: {
    *fetchCarSource( { payload: { current } }, {call, put}){
      yield put({type: 'loading', payload: {}});
      const data = yield call(CarSourceListServices.fetchCarSourceList, { current });
